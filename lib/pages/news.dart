...
import '../consts.dart';
import 'appbar.dart'; // Ensure this contains your NEWS_API_KEY
...
class _NewsPageState extends State<NewsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CommonAppBar(
        title: 'Health News', // Set the title for this page
      ),
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  margin: const EdgeInsets.symmetric(
                      vertical: 10.0,
                      horizontal: 16.0), // Added left and right margins
                  elevation: 4,
                  ...
                  child: InkWell(
                    ...
                    child: Padding(
                      // Added padding to the Card for better spacing
                      padding: const EdgeInsets.all(8.0),
                      child: Row(
                                ...
                                ? SizedBox(
                                    ...
                                    child: Image.network(
                                      ...
                                      errorBuilder:
                                        ...
                                        return Image.asset(
                                            'images/placeholder_image.jpg'); // Use a local fallback image
                                      },
                                    ),
                                  )
                                : SizedBox(
                          ...
                          Expanded(
                            child: Padding(
                              padding: const EdgeInsets.symmetric(
                                  horizontal:
                                      12.0), // Margins between image and text
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(
